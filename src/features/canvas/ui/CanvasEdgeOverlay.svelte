...
{#if coords && isSelected && !isReconnecting}
  ...
  <button
    ...
    class="pointer-events-auto absolute -translate-x-1/2 -translate-y-1/2 w-5 h-5 rounded-full bg-white border-2 border-rose-500 shadow-md hover:scale-125 cursor-grab active:cursor-grabbing flex items-center justify-center transition-transform"
  ...
  <button
    ...
    class="pointer-events-auto absolute -translate-x-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-rose-600 text-white flex items-center justify-center shadow-lg hover:scale-110 transition border border-white cursor-pointer"
